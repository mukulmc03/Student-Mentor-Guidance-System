...
<div className="container">
            <form className="form-horizontal address-form"  >
                ...
                <div className="form-group">
                    ...
                    <div className="col-sm-10">
                        <input type="text" placeholder="Address_line" className="form-control" name="" />
                    </div>
                </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-sm-10">
                        <input type="text" placeholder="Address_line2" className="form-control" name="" />
                    </div>
                </div>
        ...
        <div className="form-group">
                ...
                <div className="row">
                    <div className="col-sm-4">
                        <input type="email" placeholder="Country" className="form-control" name= "" disabled value="india" />
                    </div>
                    <div className="col-sm-4">
                                <input placeholder="State" className="form-control" name= "" disabled value="maharashtra" />
                    </div>       
                </div>
        </div>
        ...
        <div className="form-group">
                ...
                <div className="col-sm-4">
                        <input type="number" max="999999" placeholder="ex.(444604)" className="form-control" name= "" />
                </div>
        </div>
