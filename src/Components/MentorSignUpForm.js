...
class MentorSignUpForm extends Component{
    ...
    submitHandler=(event)=>{
        ...
        MentorService.registerNewMentor(this.state.courseId , newMentor).then( (response) =>{
...
render(){
    ...
    <form className="form-horizontal mentor-signup-form"  onSubmit={this.submitHandler} >


        <h2> Mentor <br/>Registration</h2>


        <div className="form-group">
            <strong className="col-sm-3 control-label">First Name*</strong>
            <div className="col-sm-9">
                <input type="text" placeholder="First Name" className="form-control" name="mentorFirstName" value={this.state.mentorFirstName} onChange={this.changeHandler} />
            </div>
        </div>
        ...
        <div className="form-group">
            ...
            <div className="col-sm-9">
                <input type="text" placeholder="Last Name" className="form-control" name="mentorLastName" value={this.state.mentorLastName}  onChange={this.changeHandler}/>
            </div>
        </div>
        ...
        <div className="form-group">
            ...
            <div className="col-sm-9">
                <input type="email" placeholder="Email" className="form-control" name= "mentorEmail" value={this.state.mentorEmail} onChange={this.changeHandler}/>
            </div>
        </div>
        ...
        <div className="form-group">
            ...
            <div className="col-sm-9">
                <input type="password" placeholder="Password" className="form-control" name="mentorPassword" value={this.state.mentorPassword} onChange={this.changeHandler}/>
            </div>
        </div>
        ...
        <div className="form-group">
            ...
            <div className="col-sm-9">
                <input type="date" className="form-control" name="mentorDob" value={this.state.mentorDob} onChange={this.changeHandler}/>
            </div>
        </div>
        ...
        <div className="form-group">
            ...
            <div className="col-sm-9">
                <input type="phoneNumber" placeholder="Phone number" className="form-control" name="mentorMoNo" value={this.state.mentorMoNo} onChange={this.changeHandler}/>
        ...
        <div className="form-group">
                <div className="row">
                        <div className="col-sm-4">
                            <strong className="col-sm-3 control-label">Batch Size* </strong>
                        </div> 
                        <div className="col-sm-4">
                            <strong className="col-sm-2 control-label">Join Year* </strong>
                        </div>   
                </div>  

                <div className="row">
                    <div className="col-sm-4">
                        <input type="number" placeholder="ex.(25)" className="form-control" name= "batchSize" value={this.state.batchSize} onChange={this.changeHandler} />
                    </div>
                    <div className="col-sm-4">
                        <input type="date"  className="form-control" name= "mentorJoinYear" value={this.state.mentorJoinYear}   onChange={this.changeHandler}/>
                    </div>       
                </div>
        </div>
        ...
        <div className="form-group">
            ...
            <div className="col-sm-6">
                ...
                <div className="col-sm-4">
                    ...
                    <input type="radio" name="mentorGender" value="MALE" onChange={this.changeHandler}/> Male
                    </label>
                </div>

                <div className="col-sm-5">  
                    <label className="radio-inline">                          
                    <input type="radio" name="mentorGender" value="FEMALE"  onChange={this.changeHandler}/> Female
                    </label>   
                </div>
        ...
        <div className="row">
                <div className="col-sm-12">
                   <strong className="col-sm-3 control-label">Rate Your Skill* </strong>
                </div> 
         </div>
        <div className="col-sm-4">
                <input type="number" max="10" placeholder="MAX=10" className="form-control" name= "avgRating" onChange={this.changeHandler} value={this.state.avgRating} />
        </div><br/>
